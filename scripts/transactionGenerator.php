...
$transaction = 204509940;
	while($i < 1){
		...
		sleep(1);
		$query = $pdo->prepare('INSERT INTO production.transactions201603 (SELECT * FROM production.transaction_spool WHERE id> :nextTransaction LIMIT 1);');
